...
import LabModal from './components/Lab Modal/LabModal';
...
const LabTestPackages = () => {
  ...
  return (
    ...
    <div className=" w-full p-5 pt-0 rounded-[9.17px] bg-white">
          ...
          <tbody>
            {data?.labTests?.map((c) => (
              <tr key={c.id} className="bg-[#F1F4FA]">
                ...
                <td
                  className={`border-t-0 px-6 align-middle text-[#2EDB72]  rounded-r-[9.14px] py-[17px] pl-20 text-left`}
                >
